...
public class PetsAndPeople {
    ...
    public static void main(String[] args) {
       ...
       allOfThePets[22] = new Cat("Kodak","Black Cat",2, Fudayl, 1f, 2f);
        ...
        //Alonso's Dog
        Dog Iggy = new Dog("Iggy", "Boston Terrier", 3, Jojo, 2f, 3);
        Jojo.pet1 = Iggy;
        //Alonso's Turtle
        Turtle Pol = new Turtle("Pol", 3, Jojo, 2f, 3);
        //Alonso's Announce
        Jojo.announce();
        Jojo.feed(Iggy, 2);
        Jojo.feed(Pol, 3);
        ...
        // FIRST: Assign values to FIELDS
        // Construct an Owner object to represent Mr. Hernandez
        Owner Niyat = new Owner("Niyat", 10, 2f, 40);
        Dog pet1 = new Dog("Alex", "pomeranian", 1, Niyat, 4f, 1f);
        // Notice that we couldn't assign a value to this field until this Dog object was constructed
        Niyat.pet1 = pet1;

        // Construct a Dog object to represent Mr. Hernandez's second pet Bowser
        Dog pet2 = new Dog("Cristina", "pomeranian", 1, Niyat, 4f, 2f);
        // Notice that we couldn't assign a value to this field until this Dog object was constructed
        Niyat.pet2 = pet2;
